...
{
  "$end", "error", "$undefined", "MISSERROR", "RETURN", "IF", "ELSE",
  "WHILE", "TYPE", "LC", "RC", "STRUCT", "COMMA", "SEMI", "ID", "INT",
  "FLOAT", "ASSIGNOP", "OR", "AND", "RELOP", "PLUS", "MINUS", "STAR",
  "DIV", "NOT", "NEG", "LP", "RP", "LB", "RB", "DOT", "LOWER_THAN_ELSE",
...
{
       0,     1,     8,    11,    34,    35,    36,    38,    39,    13,
      14,    40,    41,     0,    35,    13,    14,    37,    42,    43,
       9,    27,    13,    12,    29,     9,    46,     1,    38,    49,
